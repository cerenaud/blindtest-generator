...
def build_clip_with_background_us(
        track: AudioTrack,
        track_number: int,
        total_tracks: int,
        guessing_background: str,
...
def build_clip_with_video_and_background_us(
        track: AudioTrack,
        track_number: int,
        total_tracks: int,
        video_path: str,
    ...
    background = (
        VideoFileClip(guessing_background)
        #.with_effects([Loop(duration=guessing_duration+2)])
        .resized((1920, 1080))
    )
    background = background.subclipped(2, guessing_duration+2)
...
def build_intro_us(
    ...
    rules1 = TextClip(
        ...
        method="label",
        size=(1600, 200)
    ).with_position(("center", 100)).with_start(6).with_duration(5)
    rules1 = rules1.with_effects([FadeIn(0.8)])

    rules2 = TextClip(
        text="10 seconds to find:\n\n-The song\n\n-The artist",
        font="arial",
        font_size=100,
        color="white",
        method="label",
        size=(1600, 600)
    ).with_position(("center", 250)).with_start(6).with_duration(5)
    rules2 = rules2.with_effects([FadeIn(0.8)])
    ...
    lets_go_text = TextClip(
        ...
        method="label",
        size=(1600, 200)
    ).with_position("center").with_start(11).with_duration(2)
    lets_go_text = lets_go_text.with_effects([FadeIn(0.8)])
...
def build_outro_us(
    ...
    text = TextClip(
        ...
        method="label",
        size=(1600,150)
    ).with_position(("center",250)).with_start(0.5).with_duration(5.5)

    subtext = TextClip(
        text="Like, subscribe and comment if \n\nyou want a special music quiz!",
        font="arial",
        font_size=80,
        color="white",
        method="label",
        size=(1600, 250)
    ).with_position(("center", 500)).with_start(1.5).with_duration(5.5)
    subtext = subtext.with_effects([FadeIn(0.8)])
